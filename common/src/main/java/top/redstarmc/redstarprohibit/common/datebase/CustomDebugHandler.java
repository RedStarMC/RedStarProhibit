...
public class CustomDebugHandler implements SQLDebugHandler {
    ...
    public void beforeExecute(@NotNull SQLAction<?> action, @NotNull List<@Nullable Object[]> params) {
        serverManager.info("┏━━━━━━━━━━━━━━━━━━━━数据库 Debug━━━━━━━━━━━━━━━━━━━━━━━━");
        serverManager.info("┣# ActionUUID: {}", action.getActionUUID().toString());
        ...
        serverManager.info("┣# CreateTime: {}", String.valueOf(action.getCreateTime(TimeUnit.MILLISECONDS)));
        serverManager.info("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    }
    ...
    public void afterQuery(@NotNull SQLQuery query, long executeNanoTime, long closeNanoTime) {
        serverManager.info("┏━━━━━━━━━━━━━━━━━数据库 Debug━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        serverManager.info("┣# ActionUUID: {}", String.valueOf(query.getAction().getActionUUID()));
        serverManager.info("┣# SQLContent: {}", query.getSQLContent());
        serverManager.info("┣# CloseTime: {}  (cost {} ms)",
                String.valueOf(TimeUnit.NANOSECONDS.toMillis(closeNanoTime)),
                String.valueOf((double) (closeNanoTime - executeNanoTime) / 1000000)
        );
        serverManager.info("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    }
}
